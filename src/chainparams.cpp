...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "Chorus launch 26 aug 2025";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
public:
    CRegTestParams() {
        ...
        base58Prefixes[IDENTITY_ADDRESS] = std::vector<unsigned char>(1,100);
        base58Prefixes[INDEX_ADDRESS] = std::vector<unsigned char>(1,13);
        base58Prefixes[QUANTUM_ADDRESS] = std::vector<unsigned char>(1,78);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,189);
        //base58Prefixes[PUBKEY_ADDRESS]     = {0xCh,0xcH};
        //base58Prefixes[SCRIPT_ADDRESS]     = {0x1C,0x2C};
        //base58Prefixes[SECRET_KEY]         = {0xh7};
        // do not rely on these BIP32 prefixes; they are not specified and may change
        base58Prefixes[EXT_PUBLIC_KEY]     = {0x17,0x03,0x19,0x92};
